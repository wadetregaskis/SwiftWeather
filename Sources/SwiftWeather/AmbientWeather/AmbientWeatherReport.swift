...
open class AmbientWeatherReport: WeatherReport {
    ...
    private static let sensorMetadata: [any AnyMD] = {
        ...
        var metadata: [any AnyMD] = [
            MD<Double, UnitConcentrationMass>(.pm25,
                                              .AirQuality,
                                              "Outdoor Air Quality",
                                              .microgramsPerCubicMetre,
                                              "Measuring PM2.5"),
            MD<Double, UnitConcentrationMass>(.pm25_24h,
                                              .AirQuality,
                                              "24 Average Outdoor Air Quality",
                                              .microgramsPerCubicMetre,
                                              "Measuring PM2.5"),
            MD<Double, UnitConcentrationMass>(.pm25_in,
                                              .AirQuality,
                                              "Indoor Air Quality",
                                              .microgramsPerCubicMetre,
                                              "Measuring PM2.5"),
            MD<Double, UnitConcentrationMass>(.pm25_in_24h,
                                              .AirQuality,
            ...
            MD<Double, UnitDispersion>(.co2,
                                       ...
                                       "CO2 Level",
                                       .partsPerMillion),
            MD<Double, UnitIncidentPower>(.solarradiation,
                                          .Radiation,
                                          "Solar Radiation",
                                          .wattsPerSquareMetre),
            MD<Int, UnitUVIndex>(.uv,
                                 .Radiation,
                                 "UV Index",
                                 .uv),
            ...
            MD<Int, UnitPercentage>(.humidity,
                                    .Humidity,
                                    "Outdoor Humidity",
                                    .percentage),
            MD<Int, UnitPercentage>(.humidityin,
                                    .Humidity,
                                    "Indoor Humidity",
                                    .percentage),
            MD<String, NoUnit>(.tz,
            ...
            MD<Double, UnitPressure>(.baromabsin,
                                     ...
                                     "Absolute Pressure",
                                     .inchesOfMercury),
            MD<Double, UnitSpeed>(.hourlyrainin,
                                  .RainRate,
                                  "Hourly Rain",
                                  .inchesPerHour),
